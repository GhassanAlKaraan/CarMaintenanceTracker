...
public class RecordDetailsActivity extends AppCompatActivity {
    ...
    Button deleteRecordBtn, addReminderBtn;
    ...
    public void add_reminder(View v){
        ...
        Intent intent = new Intent(RecordDetailsActivity.this, SetReminderActivity.class);
        intent.putExtra("message0", r_name);
        //go to setReminderActivity
